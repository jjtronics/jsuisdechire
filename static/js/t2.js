(function(){
  ...
  style.textContent=`
    #t2 .t2-word{position:relative;min-height:12rem;margin-bottom:1rem;border:5px solid #c4b5fd;border-radius:1.75rem;background:radial-gradient(circle at 24% 18%,rgba(255,255,255,.95) 0 4%,transparent 5%),linear-gradient(145deg,#fff7ed,#fdf2f8 48%,#e0e7ff);box-shadow:inset 0 8px 0 rgba(255,255,255,.7),0 8px 0 #a78bfa,0 22px 34px -24px rgba(76,29,149,.35);font-size:clamp(2.4rem,10vw,5.2rem);font-weight:950;letter-spacing:-.06em;transition:color 100ms ease,transform 150ms ease,box-shadow 150ms ease;}
    ...
    #t2 .t2-color-grid button{position:relative;isolation:isolate;min-height:5.5rem;overflow:hidden;border:5px solid #c4b5fd;border-radius:1.25rem;background:linear-gradient(145deg,var(--paint-light),var(--paint) 42%,var(--paint-deep));box-shadow:inset 0 7px 0 rgba(255,255,255,.28),0 7px 0 #8b5cf6,0 18px 25px -18px rgba(76,29,149,.45);color:#fff;font-size:1rem;font-weight:950;text-shadow:0 2px 5px rgba(15,23,42,.38);transition:transform 120ms ease,box-shadow 120ms ease,filter 120ms ease;touch-action:manipulation;}
    ...
    #t2 .t2-color-grid button:not(:disabled):hover{transform:translateY(-3px) rotate(0);filter:saturate(1.1);box-shadow:inset 0 7px 0 rgba(255,255,255,.34),0 10px 0 #8b5cf6,0 22px 28px -18px rgba(76,29,149,.5);}
    #t2 .t2-color-grid button:not(:disabled):active{transform:translateY(5px) scale(.97) rotate(0);filter:brightness(.96);box-shadow:inset 0 5px 0 rgba(255,255,255,.2),0 2px 0 #8b5cf6;}
    #t2 .t2-color-grid button:disabled{opacity:.55;cursor:default;filter:grayscale(.45);}
    #t2 .t2-round-info{display:flex;justify-content:center;margin-top:1rem;padding:.7rem 1rem;border:2px solid rgba(167,139,250,.45);border-radius:9999px;background:rgba(255,255,255,.55);color:#5b21b6;font-size:.85rem;font-weight:950;}
    html.dark #t2 .t2-word{border-color:#171044;box-shadow:inset 0 8px 0 rgba(255,255,255,.7),0 8px 0 #08051f,0 22px 34px -24px rgba(2,6,23,.9);}
    html.dark #t2 .t2-color-grid button{border-color:#171044;box-shadow:inset 0 7px 0 rgba(255,255,255,.28),0 7px 0 #08051f,0 18px 25px -18px rgba(2,6,23,.9);}
    html.dark #t2 .t2-color-grid button:not(:disabled):hover{box-shadow:inset 0 7px 0 rgba(255,255,255,.34),0 10px 0 #08051f,0 22px 28px -18px rgba(2,6,23,.95);}
    html.dark #t2 .t2-color-grid button:not(:disabled):active{box-shadow:inset 0 5px 0 rgba(255,255,255,.2),0 2px 0 #08051f;}
    html.dark #t2 .t2-round-info{border-color:rgba(255,255,255,.14);background:rgba(224,231,255,.12);color:#e0e7ff;}
