(function(){
  ...
  const DICT = {
    fr: {
      ...
      "home.list1": "{count} mini-tests rapides (réaction, couleurs, poursuite, équilibre, mémoire, réflexe ping-pong)",
    ...
    en: {
      ...
      "home.list1": "{count} quick mini-tests (reaction, colors, pursuit, balance, memory, cup reflex)",
    ...
    it: {
      ...
      "home.list1": "{count} mini-test rapidi (reazione, colori, inseguimento, equilibrio, memoria, riflessi ping-pong)",
