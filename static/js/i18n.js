(function(){
  ...
  const DICT = {
    fr: {
      ...
      "home.list3": "À la fin : tu peux enregistrer ton score localement",
      ...
      "leaderboard.heading": "Classement local",
      "leaderboard.rank": "#",
    ...
    en: {
      ...
      "home.list3": "At the end: you can save your score locally",
      ...
      "leaderboard.heading": "Local leaderboard",
      "leaderboard.rank": "#",
    ...
    it: {
      ...
      "home.list3": "Alla fine: puoi salvare il tuo punteggio in locale",
      ...
      "leaderboard.heading": "Classifica locale",
      "leaderboard.rank": "#",
