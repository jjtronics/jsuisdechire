(function(){
  ...
  const DICT = {
    fr: {
      ...
      "t3.notice": "Clique sur Démarrer : le cercle part en cavale. Poursuis-le avec ta souris (ou ton doigt) et clique dessus avant qu'il ne s'échappe trop longtemps. Tu n'as droit qu'à {max_attempts} essais.",
    ...
    en: {
      ...
      "t3.notice": "Hit Start and the circle will bolt everywhere. Chase it with your mouse (or finger) and tap it before it gets away. You only get {max_attempts} tries.",
    ...
    it: {
      ...
      "t3.notice": "Premi Avvia: il cerchio impazzisce ovunque. Inseguilo con mouse o dito e cliccalo prima che scappi. Hai solo {max_attempts} tentativi.",
