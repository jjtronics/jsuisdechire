(function(){
  ...
  const DICT = {
    fr: {
      ...
      "t4.notice": "Clique sur Démarrer : le cercle se met à bouger dans tous les sens, tu dois cliquer le plus vite possible dessus pour stopper sa progression. Attention tu n'as que {max_attempts} essais.",
    ...
    en: {
      ...
      "t4.notice": "Tap Start: the circle starts moving everywhere, you have to click it as fast as possible to stop it. Careful, you only get {max_attempts} tries.",
    ...
    it: {
      ...
      "t4.notice": "Premi Avvia: il cerchio comincia a muoversi in tutti i sensi, devi cliccarlo il più velocemente possibile per fermarlo. Attenzione, hai solo {max_attempts} tentativi.",
