(function(){
  ...
  const DICT = {
    fr: {
      ...
      "home.list1": "{count} mini-tests rapides (réaction, couleurs, poursuite, équilibre, mémoire, réflexe gobelet, conduite)",
    ...
    en: {
      ...
      "home.list1": "{count} quick mini-tests (reaction, colors, pursuit, balance, memory, cup reflex, driving)",
    ...
    it: {
      ...
      "home.list1": "{count} mini-test rapidi (reazione, colori, inseguimento, equilibrio, memoria, riflessi bicchiere, guida)",
