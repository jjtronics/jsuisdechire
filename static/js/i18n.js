(function(){
  ...
  const DICT = {
    fr: {
      ...
      "results.summary_mid": "50/100 à 75 ! C'est pas mal, mais tu devrais t'arrêter là",
      "results.summary_high": "75/100 et plus ! Wahou, tu mérites un autre verre pour ce score ! Mais un dernier hein !",
    ...
    en: {
      ...
      "results.summary_mid": "50/100 to 75! Not bad, but you should call it a night now",
      "results.summary_high": "75/100 and up! Wow, you deserve another drink for that score—but make it the last one!",
    ...
    it: {
      ...
      "results.summary_mid": "Da 50/100 a 75! Niente male, ma dovresti fermarti qui",
      "results.summary_high": "75/100 e oltre! Wow, ti meriti un altro drink per questo punteggio… ma che sia l'ultimo!",
