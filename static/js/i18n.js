(function(){
  ...
  const DICT = {
    fr: {
      ...
      "results.balance_cheat_detected": "Triche détectée : σ {std} g ≤ seuil {threshold} g. Score total fixé à -42.",
    ...
    en: {
      ...
      "results.balance_cheat_detected": "Cheating detected: σ {std} g ≤ threshold {threshold} g. Total score forced to -42.",
    ...
    it: {
      ...
      "results.balance_cheat_detected": "Trucco rilevato: σ {std} g ≤ soglia {threshold} g. Punteggio totale fissato a -42.",
